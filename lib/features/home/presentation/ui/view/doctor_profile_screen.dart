...
// final Doctor doctor;
//   // تعديل الـ Constructor لاستقبال البيانات
// const DoctorProfileScreen({super.key, required this.doctor});  @override
...
//       ),
//        Text(
//         doctor.specializationAr ?? "تخصص غير محدد", // تأكدي من إضافة التخصص في الموديل
...
//         _buildTimeInfo("To Time", doctor.toTime ?? "--:--"),                 // خط فاصل عمودي
...
//                     children: [
// Text(
//         doctor.slotTime != null ? doctor.slotTime.toString() : "0", 
//         style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)

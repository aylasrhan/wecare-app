...
// import 'package:wecare/model/doctor_model.dart'; // تأكدي من مسار ملف الزيارات
...
//         String responseString = utf8.decode(
//           response.bodyBytes,
//           allowMalformed: true,
//         );
...
//             ),
//             SizedBox(height: 15),
//             famousDoctors.isEmpty
//                 ? Text("لا يوجد أطباء مميزون حالياً")
//                 : ListView.builder(
//                     shrinkWrap: true, // مهم جداً داخل الـ SingleChildScrollView
//                     physics:
//                         NeverScrollableScrollPhysics(), // لمنع التعارض في السكرول
//                     itemCount: famousDoctors.length,
//                     itemBuilder: (context, index) {
//                       var doctor = famousDoctors[index];
//                       print("بيانات الطبيب المستلمة: $doctor");
...
//    onTap: () {
//   // نقوم بتحويل الـ Map<dynamic, dynamic> إلى Map<String, dynamic> أولاً
//   final Map<String, dynamic> doctorMap = Map<String, dynamic>.from(doctor);
  
//   // الآن يمكننا تحويله إلى الـ Model
//   Doctor doctorModel = Doctor.fromJson(doctorMap); 
  
//   Navigator.push(
//     context,
//     MaterialPageRoute(
//       builder: (context) => DoctorProfileScreen(doctor: doctorModel),
//     ),
//   );
// },
//       child: Container(
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   // عرض الاسم من البيانات القادمة من السيرفر
//                   Text(
...
//                   ),
//                   SizedBox(height: 5),
//                   // النجوم (يمكنك لاحقاً جعل التقييم ديناميكياً)
//                   Row(
//                     children: [
...
//   Widget _buildCategoryTile(BuildContext context, Map clinic) {
//     // استقبال الـ clinic بالكامل وليس فقط العنوان
//     return GestureDetector(
//       onTap: () {

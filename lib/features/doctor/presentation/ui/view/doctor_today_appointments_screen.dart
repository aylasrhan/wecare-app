...
//     );
//     // تحديث الشاشة لإزالة الموعد من الطلبات المعلقة
//     setState(() {}); 
//   } else {
//     ScaffoldMessenger.of(context).showSnackBar(
...
class _DoctorAppointmentsScreenState extends State<DoctorAppointmentsScreen> {
  ...
  //                         const SnackBar(content: Text('تم قبول الموعد بنجاح')),
  //                       );
  //                       // تحديث الشاشة لإزالة الموعد من الطلبات المعلقة ونقله للمؤكدة
  //                       setState(() {}); 
  //                     } else {
  //                       ScaffoldMessenger.of(context).showSnackBar(
  //                         const SnackBar(content: Text('فشل قبول الموعد، حاول مرة أخرى')),
        ...
        child: Column(
          children: [
            ListTile(
              ...
              // 2. نستخدم Row لترتيب الكلمة العربية قبل الاسم الأجنبي
              // title: Row(
              //   children: [
              //     const Text("المريض: ", style: TextStyle(fontWeight: FontWeight.bold)),
              //     Text(patientNameOrId, style: const TextStyle(fontWeight: FontWeight.bold)),
              //   ],
              // ),
              title: Text.rich(
                TextSpan(
